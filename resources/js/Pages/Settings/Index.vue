                    ...
                    <div v-for="type in maintenanceTypes" :key="type.id">
                        ...
                        <div v-if="editingId !== type.id" class="flex items-center justify-between bg-gray-50 rounded-lg px-3 py-2.5">
                            ...
                            <div class="flex gap-1 ml-2 shrink-0">
                                ...
                                <button type="button" @click="testAlert(type.id)" title="Tester l'alerte Discord"
                                    class="text-gray-400 hover:text-indigo-500 p-1.5">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const testAlertForm = useForm({})
function testAlert(id) {
    testAlertForm.post(route('maintenance-types.test-alert', id))
}
</script>
