<template>
    <div class="min-h-screen bg-gray-50 px-4 py-8">
        <div class="max-w-lg mx-auto">
            <div class="mb-8">
                <h1 class="text-2xl font-bold text-gray-900">Configurer ma moto</h1>
                <p class="text-sm text-gray-500 mt-1">Ces informations servent à personnaliser votre carnet d'entretien.</p>
            </div>
            ...
            <form @submit.prevent="submit" class="bg-white shadow rounded-xl p-6 space-y-5">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input v-model="form.make" type="text" required placeholder="Honda"
                    ...
                    <div>
                        ...
                        <input v-model="form.model" type="text" required placeholder="CB650R"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input v-model="form.year" type="number" required placeholder="2022" min="1900" :max="new Date().getFullYear() + 1"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                    ...
                    <div>
                        ...
                        <input v-model="form.plate" type="text" placeholder="AB-123-CD"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input v-model="form.initial_mileage" type="number" required placeholder="0" min="0"
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-400">JPG ou PNG, max 5 Mo</p>
                    <p v-if="form.errors.photo" class="mt-1 text-xs text-red-600">{{ form.errors.photo }}</p>
                    <img v-if="photoPreview" :src="photoPreview" class="mt-3 h-32 w-auto rounded-lg object-cover" />
                </div>
                ...
                <button type="submit" :disabled="form.processing"
                    ...
                    {{ form.processing ? 'Enregistrement…' : 'Enregistrer ma moto' }}
                </button>
            </form>
        </div>
    </div>
