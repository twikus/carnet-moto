    ...
    <div class="min-h-screen bg-gray-50 pb-8">
        ...
        <div class="bg-white shadow-sm px-4 py-4 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-gray-400">{{ motorcycle.year }} · {{ motorcycle.plate ?? 'Sans immatriculation' }}</p>
            </div>
        ...
        <div class="px-4 mt-6 space-y-4 max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow p-5 flex items-center justify-between">
                ...
                <button class="bg-orange-50 text-orange-600 hover:bg-orange-100 text-sm font-medium px-3 py-2 rounded-lg transition-colors">
                    Mettre à jour
                </button>
            </div>
                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-2">
                                ...
                                <span v-if="dashboard.lastMaintenance.garage"> · {{ dashboard.lastMaintenance.garage }}</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                <button class="bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 px-4 rounded-xl text-sm transition-colors flex items-center justify-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                    </svg>
                    Ajouter une intervention
                </button>
                <button class="bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-xl text-sm border border-gray-200 transition-colors flex items-center justify-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-xl shadow p-5">
                ...
                <div v-if="dashboard.upcomingMaintenances.length === 0"
                ...
                <div v-else class="space-y-3">
                    <div v-for="item in dashboard.upcomingMaintenances" :key="item.id"
                        ...
                        <div class="text-right">
                            ...
                            <span v-if="item.km_left !== null && item.days_left !== null" class="text-xs text-gray-300 mx-1">·</span>
